...
<div class="fill_message">
    <form name="ctl00" method="post" action="${pageContext.request.contextPath}/user/rejister.action" id="f">
        <h2>
            以下均为必填项
        </h2>
        <table class="tab_login">
            ...
            <tr>
                ...
                <td>
                    <img class="yzm_img" id='imgVcode' src="/image/imgCode.action"/>
                    ...
                    <div class="text_left t1">
                        <p class="t1">
                            ...
                            <a href="#" id="codeFl">看不清楚？换个图片</a><br/>
